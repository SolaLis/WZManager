...
public class SqbDrActivity extends BaseActivity implements SqbmxContract.View {
    ...
    private void setAdapter() {
        ...
        if ("1".equals(islistPush)){
            ...
            //设置布局管理者
            LinearLayoutManager layoutManager=new LinearLayoutManager(SqbDrActivity.this);
            ...
            rvDrsq.addItemDecoration(new RecycleViewDivider(
                    SqbDrActivity.this, LinearLayoutManager.HORIZONTAL, 1, R.color.color_b5));
