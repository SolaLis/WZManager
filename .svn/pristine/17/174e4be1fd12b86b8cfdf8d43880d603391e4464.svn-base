...
public class SqlyAdapter extends RecyclerView.Adapter<SqlyAdapter.ViewHolder> {
private List<SqbmxBean> sqbmxBeanList;
    ...
    public SqlyAdapter(List<SqbmxBean> sqbmxBeanList, List<CHScrollView2> mHScrollViews, RecyclerView rv) {
        this.sqbmxBeanList = sqbmxBeanList;
        this.mHScrollViews = mHScrollViews;
        this.rv = rv;
    }

    public SqlyAdapter(List<SqbmxBean> sqbmxBeanList, List<CHScrollView1> mHScrollViews1, RecyclerView rv, int flag) {
        this.sqbmxBeanList = sqbmxBeanList;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if ("1".equals(SharedPreferencesUtil.getStringData(MyApplication.getContext(),
                "islistPush", null))) {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_sqdmx_lysq, parent, false);
            //第一次初始化的时候装进来
            addHViews((CHScrollView2) view.findViewById(R.id.item_chscroll_scroll));
        } else {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_sqdmx_lysq_1, parent, false);
            //第一次初始化的时候装进来
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.tvItemSqbmxLysq9.setText(sqbmxBean.getWLBZ());
        holder.tvItemSqbmxLysq10.setText(sqbmxBean.getYFSL());
        holder.tvItemSqbmxLysq11.setText(sqbmxBean.getYJS());
    ...
    public void addHViews1(final CHScrollView1 hScrollView) {
        Log.e("LOG","addHViews1(SqcgAdapter.java:154)==="+0);
