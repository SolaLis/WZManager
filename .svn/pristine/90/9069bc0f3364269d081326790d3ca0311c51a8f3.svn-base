...
public class SqbLyActivity extends BaseActivity implements SqbmxContract.View {
    ...
    private void setAdapter() {
        if ("1".equals(islistPush)){
            ...
            LinearLayoutManager layoutManager = new LinearLayoutManager(SqbLyActivity.this);
            ...
            rvLysq.addItemDecoration(new RecycleViewDivider(
                    SqbLyActivity.this, LinearLayoutManager.HORIZONTAL, 1, R.color.color_b5));
