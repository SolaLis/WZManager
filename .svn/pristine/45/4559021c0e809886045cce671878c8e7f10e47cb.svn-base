...
public class ASqbXsActivity extends BaseActivity implements ASqbmxContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ("1".equals(islistPush)) {
            setContentView(R.layout.activity_sqb_xs);
        }else {
            setContentView(R.layout.activity_sqb_xs_1);
        }
    ...
    private void setAdapter() {
        if ("1".equals(islistPush)){
            adapter = new SqcgAdapter(sqbmxBeanList,mHScrollViews,rvXssq);
            //设置布局管理者
            LinearLayoutManager layoutManager=new LinearLayoutManager(ASqbXsActivity.this);
            layoutManager.setOrientation(LinearLayoutManager.HORIZONTAL);
            rvXssq.setLayoutManager(layoutManager);
        } else {
            adapter = new SqcgAdapter(sqbmxBeanList, mHScrollViews1, rvXssq, 1);
            //设置布局管理者
            LinearLayoutManager layoutManager = new LinearLayoutManager(ASqbXsActivity.this);
            ...
            rvXssq.addItemDecoration(new RecycleViewDivider(
                    ASqbXsActivity.this, LinearLayoutManager.HORIZONTAL, 1, R.color.color_b5));
            rvXssq.setAdapter(adapter);
    }
