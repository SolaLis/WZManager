...
import gjp.com.wzmanager.adapter.SqzyAdapter;
...
public class ASqbZyActivity extends BaseActivity implements ASqbmxContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ("1".equals(islistPush)) {
            setContentView(R.layout.activity_sqb_zy);
        }else {
            setContentView(R.layout.activity_sqb_zy_1);
        }
    ...
    private void setAdapter() {
        LinearLayoutManager layoutManager=new LinearLayoutManager(ASqbZyActivity.this);
        if ("1".equals(islistPush)){
            adapter = new SqzyAdapter(sqbmxBeanList,mHScrollViews,rvZysq);
            layoutManager.setOrientation(LinearLayoutManager.HORIZONTAL);
            rvZysq.setLayoutManager(layoutManager);
        } else {
            adapter = new SqzyAdapter(sqbmxBeanList, mHScrollViews1, rvZysq, 1);
            layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
            rvZysq.setLayoutManager(layoutManager);
        }
            rvZysq.addItemDecoration(new RecycleViewDivider(
                    ASqbZyActivity.this, LinearLayoutManager.HORIZONTAL, 1, R.color.color_b5));
            rvZysq.setAdapter(adapter);
