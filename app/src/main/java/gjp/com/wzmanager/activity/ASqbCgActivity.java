...
public class ASqbCgActivity extends BaseActivity implements ASqbmxContract.View {
    ...
    private void setAdapter() {
            if ("1".equals(islistPush)){
                ...
                LinearLayoutManager layoutManager=new LinearLayoutManager(ASqbCgActivity.this);
            ...
            rvCgsq.addItemDecoration(new RecycleViewDivider(
                    ASqbCgActivity.this, LinearLayoutManager.HORIZONTAL, 1, R.color.color_b5));
