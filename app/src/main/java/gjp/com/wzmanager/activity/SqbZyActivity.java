...
public class SqbZyActivity extends BaseActivity implements SqbmxContract.View {
    ...
    private void setAdapter() {
        LinearLayoutManager layoutManager=new LinearLayoutManager(SqbZyActivity.this);
        if ("1".equals(islistPush)){
            ...
            rvZysq.addItemDecoration(new RecycleViewDivider(
                    SqbZyActivity.this, LinearLayoutManager.HORIZONTAL, 1, R.color.color_b5));
